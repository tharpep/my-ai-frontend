...
import { Save, RotateCcw, CheckCircle, Key, Database, Bell, Sparkles, Plus, Trash2, Edit2 } from "lucide-react";
import { useProfilesStore } from "@/stores/profilesStore";

export default function SettingsPageMock() {
  const { profiles, activeProfileId, setActiveProfile, deleteProfile } = useProfilesStore();
          ...
          <div className="rounded-lg border border-zinc-800 bg-zinc-900 p-6">
            <div className="mb-4 flex items-center justify-between">
              <div className="flex items-center gap-2">
                ...
                <h2 className="text-lg font-semibold text-zinc-100">AI Profiles</h2>
              </div>
            ...
            <p className="mb-4 text-sm text-zinc-400">
              Save and quickly switch between different AI configurations
            </p>
              ...
              {profiles.map((profile) => (
                ...
                >
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    <button className="rounded p-2 text-zinc-500 hover:bg-zinc-800 hover:text-zinc-300">
